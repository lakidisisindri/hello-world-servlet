  ...
  //     waitForQualityGate abortPipeline: true
    //    }
     ...
     stage('Artifact upload') {
      steps {
    nexusArtifactUploader artifacts: [[artifactId: 'hello-world-servlet-example', classifier: '', file: '/var/lib/jenkins/workspace/sample-pipline/target/helloworld.war', type: 'war']], credentialsId: 'nexus', groupId: 'com.geekcap.vmturbo', nexusUrl: 'http://18.141.187.24/:8081/nexus', nexusVersion: 'nexus2', protocol: 'http', repository: 'https://github.com/lakidisisindri/hello-world-servlet.git', version: '1.0-SNAPSHOT'
 }
    }
}
post {
